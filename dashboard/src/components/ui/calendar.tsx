...
function Calendar({ className, classNames, ...props }: React.ComponentProps<typeof DayPicker>) {
  return <DayPicker
    ...
    classNames={{
      ...
      month: "space-y-4",
      month_caption: "flex items-center justify-center h-7 px-7",
      caption_label: "text-sm font-medium",
      nav: "flex items-center gap-1",
      button_previous: "absolute start-1 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
      button_next: "absolute end-1 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
      chevron: "size-4",
