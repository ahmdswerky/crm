...
export interface BarProps {
  ...
  colorByData?: boolean; // assigns the series palette across individual data points
  ...
  Children.forEach(children, (child) => {
    ...
    if (type === Bar) {
      ...
      bars.push({
        ...
        colorByData: props.colorByData ?? false,
      ...
      bar.colorByData
        ? values.map((value, i) => {
            ...
            return {
              ...
              itemStyle: {
                ...(bar.colorByData ? { color: slots[i % Math.max(1, slots.length)] } : {}),
