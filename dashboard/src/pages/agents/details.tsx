...
import { AgentDeals, AgentDetailsState, AgentDialog, AgentLeads, canDeleteAgent, detailsPath, ForbiddenAgents, PermissionGroups, RoleReference, type Role, type User, type UserEnvelope } from "./shared"
